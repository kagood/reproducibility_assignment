...
```{r}
mean_closedloop_grasp_uncrowded_3cm <- grasping_means$mean[4] # calculates mean for viewing: closed loop, task: grasp, crowding: uncrowded, target size: 3cm
...
```{r}
!(images/original_paper_plots.png)
```
